    ...
    currentFilter == "chapters" && (
      ...
      >
        ...
        <input
          ...
          className="bg-light-dark-orange dark:bg-light-navy dark:text-primary-white dark:ring-navy w-full rounded-full px-4 py-2 text-black ring-1 ring-[#ffae67] outline-hidden placeholder:text-black placeholder:opacity-50 dark:text-white dark:placeholder:text-white"
        />
      </form>
    )
  );
